...
<div class="slider-container">
  <input type="range" min="0" max="20" value="0" step="0.1" class="slider" id="vs-slider">
...
// Al cargar la página, mostrar la aguja en 0 (mínimo de fuelFlow)
window.addEventListener('DOMContentLoaded', function() {
  updateNeedleAndValue(0);
});

// Mapea el valor de fuelFlow (0-20) al ángulo de la aguja (200° a 160°) en sentido horario, recorriendo 320°
...
ws.onmessage = (msg) => {
  ...
  if (!userIsSliding && vsSlider && manifold >= 0 && manifold <= 20) {
