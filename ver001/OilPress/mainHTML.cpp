...
<!-- Control deslizante para Oil Press     -->
<div class="slider-container">
  <input type="range" min="0" max="120" value="0" step="0.1" class="slider" id="vs-slider">
...
// Al cargar la página, mostrar la aguja en 0 (mínimo de Oil Press)
window.addEventListener('DOMContentLoaded', function() {
  updateNeedleAndValue(0);
});

// Mapea el valor de Oil Press (0-120) al ángulo de la aguja (270° a 90°) en sentido horario, recorriendo 180°
function manifoldToAngle(manifold) {
  ...
  // Recorrido horario de 180°: de 270° a 90° pasando por 360°/0°
  // Si el ángulo final es menor que el inicial, sumamos 360 para el recorrido
  let angleSpan = (maxAngle + 360 - minAngle) % 360; // 90 + 360 - 270 = 180
...
ws.onmessage = (msg) => {
  ...
  if (!userIsSliding && vsSlider && manifold >= 0 && manifold <= 120) {
